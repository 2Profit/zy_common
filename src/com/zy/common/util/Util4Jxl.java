...
public class Util4Jxl {
	 ...
	 * @return
	 */
	public static WritableCell getCell(int column, int row, Object obj, CellFormat cellFormat){
	...
	public static WritableSheet addLine(WritableSheet ws, Object[] values, int column, int row, CellFormat cellFormat) 
		...
		for (int i = 0; i < values.length; i++) {
			ws.addCell(getCell(column+i, row, values[i], cellFormat));
		}
		return ws;
	}
